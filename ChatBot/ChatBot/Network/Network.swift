...
class Network {
    ...
    class func LOCAL(
        returnValue returnValue: AnyObject?,
    ...
    class func LOCAL(
        ...
        // simulate network call
        DispatchQueue.main.asyncAfter(deadline: .now() + .milliseconds(500)) {
            let nsError = NSError(domain: "", code: 500, userInfo: nil)
            error?(nsError, 500, nil, returnValue)
    ...
    class func GET(
        ...
        backgroundTask = app.beginBackgroundTask(withName: "com.domain.app.jsondownload") {
